...
import "./homeLoder.css"

const HomeLoder: React.FC = () => {
    return (
        <>
            <div className='fixed inset-0 flex items-center justify-center z-50 h-screen w-screen bg-gray-600 bg-opacity-35'>
